...
const FeedbackForm = () => {
  ...
  return (
    <form action="">
        <div>
            <h3 className="text-headingColor text-[16px] leading-6 font-semibold mb-4 mt-0">How would rate the overall erperience?* </h3>
            <div>
                {
        ...
        <div className='mt-[30px]'>
            <h3 className="text-headingColor text-[16px] 
            leading-6 font-semibold mb-4 mt-0">Share your suggestions 
            and feedback </h3>
