    ...
    {/*=======hero section ========*/}
      ...
      <section className='hero__section pt-[60px] 2xl:h[800px]'>
        <div className='container'>
          <div className='mt-[30px] lg:mt-[25px] flex flex-col lg:flex-row 
          lg:items-center gap-5 lg:gap-[70px]'>
            {/*====hero content ======*/}
            <div >
              <div className='lg:w-[570px]'>
                ...
                <p className='text__para'>
                  bsbhb habhbf  wjfkwwf wqkfwbjbfk njenffj fjqnlkkfnlk qnlkjerblbl 
                  hhsadfu  klaeif ie8 c kaje  fhfancnv eufwufbq    ohownlv bv wu
                </p>
        ...
        lg:gap-[30px] mt-[30px] lg:mt-[55px]'>
          <div className='py-[30px] px-5'>
            ...
            <div className='mt-[30px]'>
              ...
              <p className='text-[16px] leading-7 text-textColor font-[700] mt-4 
              text-center'>world-class care for everyone. Our health system offers 
              unmatched ,exper health care. From the lab to the clinic.</p>
      ...
      <section>
        <div className='container'>
          <div className='xl:w-[470px] mx-auto'>
            ...
            Our health System offers unmatched, expert health care.</p>
                  ...
                  lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-[6px] lg:gap-3">
                          <p className="text-[15px] leading-[10px] lg:leading-5 
                          text-headingColor font-[600]">Tue, 24</p>
                          <p className="text-[10px] leading-[10px] lg:leading-5 
                          text-textColor font-[600]">10:00 AM</p>
                        </div>
                        <span className="w-5 h-5 lg:w-[34px] lg:h-[34px] flex 
                        items-center justify-center bg-yellowColor rounded py-1 px-[6px] 
                        lg:py-3 lg:px-[9px]">
