          ...
          <div className="rounded-l-lg lg:pl-16 py-10">
            ...
            <form onSubmit={submitHandler}>
              ...
              <div className="mb-5 flex items-center gap-3">
                <figure className='w-[60px] h-[60px] rounded-full border-2 border-soloid border-primaryColor flex items-center justify-center'>
              ...
              <div className="mt-7">
            <button className="w-full bg-primaryColor text-white texxt-[18px] leading-[30px] rounded-lg px-4 py-3">
              Sign Up
            </button>
          </div>
          <p className="mt-5 text-textColor text-center">
            Already have an account ? <Link to='/Login' className='text-primaryColor font-medium '>Login </Link>
          </p>
            </form>
